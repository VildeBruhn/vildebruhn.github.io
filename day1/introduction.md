...
The evoTS and paleoTS packages facilitate univariate and multivariate analyses of phenotypic change within lineages.
...
evoTS contains a range of multivariate models, including different versions of multivariate unbiased random walks and Ornstein-Uhlenbeck processes. Together, these models allow the user to test various hypotheses of trait evolution. That is, whether traits change in a correlated or uncorrelated manner, whether one trait/variable affects the optimum of a second trait ([Granger causality](https://en.wikipedia.org/wiki/Granger_causality)), whether adaptation in different traits happen independently toward fixed optima, etc.
...
In this workshop we will use time series to focus on univariate analysis, adequacy and multivariate analysis of several phenotypic traits as well as abiotic factors. But first, we are going to learn how data is treated in evoTS.

Let's get [started]({% link day1/data_import.md %})!
