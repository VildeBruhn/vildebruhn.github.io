...
Now that we have looked at the multivariate unbiased random walk models, let's learn more about the [multivariate Ornstein-Uhlenbeck models]({% link day2/multivar_OU.md %}).
